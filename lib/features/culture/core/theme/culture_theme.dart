...
abstract final class CultureTheme {
  ...
  static const Color cyanTurquoise  = Color(0xFF40BBCC); // Cyan technologique ponctuel
  ...
  static const Color lightBackground= Color(0xFFFFFFFF); // Fond blanc lumineux & épuré
  static const Color lightSurface   = Color(0xFFFFFFFF); // Carte blanche pure
  static const Color lightSurfaceAlt= Color(0xFFF8FAFC); // Surface surélevée subtile
  static const Color lightBorder    = Color(0xFFE2E8F0); // Bordure discrète et élégante
